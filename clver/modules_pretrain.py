...
class Model(nn.Module):
    def __init__(self, ff_dim, img_embs, n_hidden, n_head, n_block, img_enc_block, vocab_size, dropout, max_len, tasks, tmp, CLS):
        ...
        self.fda_tmp = tmp
        print("fda temperature", self.fda_tmp)
        self.neg_num = 6
